...
import {
  ...
  GET_USER_ALL_IMAGES_BY_ID
} from "./types";
import { API_GATEWAY } from "../utils/config";

export const addPost = postData => dispatch => {
  axios
    .post(`${API_GATEWAY}/api/posts`, postData)
    .then(res => {
      dispatch({
        type: ADD_POST,
        payload: res.data
...
export const getUnApprovedPosts = () => dispatch => {
  axios
    .get(`${API_GATEWAY}/api/posts/unapproved`)
    .then(res => {
      dispatch({
...
export const approvePosts = postId => dispatch => {
  axios
    .put(`${API_GATEWAY}/api/posts/conversion/${postId}`)
    .then(res => {
      dispatch({
        type: APPROVE_POST,
        payload: res.data
...
export const disapprovePost = postId => dispatch => {
  axios
    .delete(`${API_GATEWAY}/api/posts/disapprove/${postId}`)
    .then(res => {
      dispatch({
...
export const likePost = postId => dispatch => {
  axios
    .post(`${API_GATEWAY}/api/posts/like/${postId}`)
    .then(res => {
      dispatch({
        type: LIKE_POST,
        payload: res.data
...
export const unlikePost = postId => dispatch => {
  axios
    .post(`${API_GATEWAY}/api/posts/unlike/${postId}`)
    .then(res => {
      dispatch({
        type: UNLIKE_POST,
        payload: res.data
...
export const addComments = (formdata, commentsId, navigate) => dispatch => {
  axios
    .post(`${API_GATEWAY}/api/posts/comment/${commentsId}`, formdata)
    .then(res => {
      dispatch({
...
export const getUserPosts = () => dispatch => {
  axios
    .get(`${API_GATEWAY}/api/posts/currentuserpost`)
    .then(res => {
      dispatch({
        type: GET_USER_POSTS,
        payload: res.data
...
export const getUserMedia = () => dispatch => {
  axios
    .get(`${API_GATEWAY}/api/posts/media`)
    .then(res => {
      dispatch({
        type: GET_USER_MEDIA,
        payload: res.data
...
export const getPostId = postId => dispatch => {
  axios
    .get(`${API_GATEWAY}/api/posts/${postId}`)
    .then(res => {
      dispatch({
        type: GET_POST_ID,
        payload: res.data
...
export const getAllUserPostsById = postsById => dispatch => {
  axios
    .get(`${API_GATEWAY}/api/posts/all/${postsById}`)
    .then(res => {
      dispatch({
...
export const getAllUserImagesById = imagesById => dispatch => {
  axios
    .get(`${API_GATEWAY}/api/posts/allimages/${imagesById}`)
    .then(res => {
      dispatch({
